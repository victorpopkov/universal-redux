...
// since we use .babelrc for client and server, and we don't want HMR enabled on the server, we have
// to add the babel plugin react-transform-hmr manually here.
